!function() {
    ...
    function L(t) {
        ...
        (n = i === t.f.serif && e === t.f["sans-serif"]) || (n = B() && O(t, i, e)),
            n ? it() - t.A >= t.w ? B() && O(t, i, e) && (null === t.u || t.u.hasOwnProperty(t.a.c)) ? $(t, t.v) : $(t, t.B) : D(t) : $(t, t.v)
    }
    function D(t) {
            ...
            if (0 === e.length && a)
                ...
                for (f = 0; f < e.length; f++) {
                    ...
                    p.g && r(p.f, [p.a.c("wf", d.c, j(d).toString(), "loading")]),
                        C(p, "fontloading", d),
                        p = null,
                    null === at && (at = !!window.FontFace && (!(d = /Gecko.*Firefox\/(\d+)/.exec(window.navigator.userAgent)) || 42 < parseInt(d[1], 10))),
                        p = at ? new I(i(n.g, n),i(n.h, n),n.c,l,n.s,u) : new P(i(n.g, n),i(n.h, n),n.c,l,n.s,t,u),
                        h.push(p)
                }
    ...
    q.prototype.g = function(t) {
        var n = this.a;
        n.g && r(n.f, [n.a.c("wf", t.c, j(t).toString(), "active")], [n.a.c("wf", t.c, j(t).toString(), "loading"), n.a.c("wf", t.c, j(t).toString(), "inactive")]),
            C(n, "fontactive", t),
            this.o = !0,
            H(this)
    }
        ...
        U.prototype.load = function(t) {
            var n, i, e = this.a.urls || [], o = this.a.families || [], s = this.a.testStrings || {}, a = new p;
            for (n = 0,
                     i = e.length; n < i; n++)
                l(this.c, e[n], d(a));
            var r = [];
    ...
    "function" == typeof define && define.amd ? define(function() {
        return dt
    }) : "undefined" != typeof module && module.exports ? module.exports = dt : (window.WebFont = dt,
